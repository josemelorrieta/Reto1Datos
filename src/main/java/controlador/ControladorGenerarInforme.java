		...
		if (!ruta.equals("")) {
			try {
				...
				for (int i = 0; i < emple.size(); i++) {
					...
					printW.println("Localización del centro:");
					printW.println(
							"	Código del centro: " + emple.get(i).getDepartamento().getLocalizacion().getCodigo());
					printW.println(
							"	Nombre del centro: " + emple.get(i).getDepartamento().getLocalizacion().getNombre());
					...
					if (emple.get(i).getResponsable() != null) {
						...
						printW.println(
								"	Cargo responsable: " + emple.get(i).getResponsable().getCargo().getNombre());
