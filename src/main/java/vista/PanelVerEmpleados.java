...
public class PanelVerEmpleados extends JPanel {
	...
	private JLabel lblTituloDNI, lblTituloNombre, lblTituloSueldo, lblTituloCargo, lblTituloDepartamento, lblTituloJefe,
			lblTituloResponsable, lblTituloFechaDeAlta;
